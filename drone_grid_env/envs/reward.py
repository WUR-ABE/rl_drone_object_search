...
from .utils import count_gt_classified_objects, setdiff2d
...
class RewardSpace:
    ...
    @contextmanager
    def calculate_reward(self, world: BaseWorld, drone: Drone, stopping_criteria: StoppingCriteria, action: int) -> Iterator[None]:
        self._reward = 0.0
