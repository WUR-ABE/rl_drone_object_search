...
if contains_option "detection_errors" "$@"; then
    ...
    if contains_option "fields2cover" "$@"; then
        gnome-terminal -- python3 evaluate.py fields2cover --output_folder evaluations/detection_errors --prefix detection_uncertainty --n_episodes 1000 --env_args config_file=experiments/detection_errors/env_config_level_2.yaml --seed 1234 --video
    fi
fi
